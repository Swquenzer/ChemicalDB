...
*/
function generateBarcode($cas, $destination, $size=20, $code_type="code128", $orientation="horizontal") {
	...
	if (!function_exists('imageCenterString')) {
	...
	imageCenterString($image, 5, $cas, $textcolor);

	// Save barcode to file
	imagepng($image, "{$destination}/{$cas}.png", 0, NULL);
	imagedestroy($image);
}
?>